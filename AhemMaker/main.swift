...
func bslnTable() -> Data {
    ...
    append(result, value: UInt16(200)) // Default Baseline
    append(result, value: Int16(200)) // Distance to Roman baseline
    for _ in 1 ..< 32 {
...
do {
    try result.write(toFile: "/Users/litherum/tmp/outputbsln.ttf", options: .atomic)
} catch {
    fatalError()
}
