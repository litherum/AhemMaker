...
func createCheckerboardImage() -> CGImage {
    let width = 64 // Must be a multiple of 32, see rdar://81639439
    let height = 64
...
let commonGlyph = Glyph(advanceWidth: 64, leftSideBearing: 0, topBearing: 51, image: checkerboardImage, name: "")
